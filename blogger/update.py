...
import os, re, publish, prepare, itertools
import core
...
def update(dry_run, bs, blog_id):
	...
	for d, b in itertools.izip(diskfeed, unending_bloggerfeed):
		...
		title, doc = prepare.prepare(root, name, autolinks)
		if b:
			print "Considering", d
			should_update = False
